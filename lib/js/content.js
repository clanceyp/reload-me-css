(function($, _, context){
    ...
    function init(){
        ...
        chrome.runtime.onMessage.addListener(function(request, sender, sendResponse){
            ...
            if (request.action && request.action === "getCSSList"){
                ...
                reloadcss.log('reload-css request;', request);
            }
        });
    }
    ...
    function updateCssHref(){
        ...
        if (!isActive || link.length === 0 ) {
            reloadcss.log('CSS Reload', link.length, isActive);
            return false;
        }
        ...
        link.forEach(function( sheet , index ){
            ...
            if (reload && isValidCSSFile)    { // update href if it exists
                ...
                reloadcss.log('Updated stylesheet  at ' , date  , href);
            }
        });
        return true;
    }
